...
infraPartners:
  ...
  - name: docker
    ...
    logo: docker.png
supportBanner:
  title: Implementation & production support
  description: Implementation support, legacy IAM migrations, architecture guidance, and production SLAs are available through Wren Security partners.
  actions:
    - text: Talk to a Partner
      link: '#'
deliverBanner:
  title: Deliver enterprise IAM solutions
  description: The Wren Security partner ecosystem is open to IAM consultants and system integrators delivering Wren Security-based solutions for their clients.
  actions:
...
<ActionBanner class="wren-support-banner" v-bind="frontmatter.supportBanner" />
<ActionBanner v-bind="frontmatter.deliverBanner" />
