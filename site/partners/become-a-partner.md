...
<CardGrid :columns="2" class="wren-partner-card-grid">
  <FeatureCard>
    ...
    <template #description>
      Wren Security components are freely available and built on established identity standards, including OAuth 2.0, OpenID Connect, SAML, and LDAPv3.
    </template>
  </FeatureCard>
  <FeatureCard>
    <template #title>
    ...
    <template #description>
      Solutions can be designed around specific client requirements without dependency on commercial licensing models.
    </template>
  </FeatureCard>
  <FeatureCard>
    <template #title>
    ...
    <template #description>
      Architecture discussions, implementation guidance, and technical support are available when deeper platform expertise is useful.
    </template>
  </FeatureCard>
  <FeatureCard>
    <template #title>
...
<Timeline>
  <TimelineItem>
    <template #label>01</template>
    <template #title>
      Start the conversation
    </template>
    <template #description>
      A first discussion covers IAM experience, typical client projects, and the intended use of Wren Security.
    </template>
  </TimelineItem>
  <TimelineItem>
    <template #label>02</template>
    <template #title>
      Explore the technical fit
    </template>
    <template #description>
      Relevant Wren Security components, architecture considerations, and areas where technical guidance may be useful are discussed.
    </template>
  </TimelineItem>
  <TimelineItem>
    <template #label>03</template>
    <template #title>
      Work on real projects
    </template>
    <template #description>
      Collaboration can continue around evaluations, architecture design, implementation, migration, or production deployment as needed.
    </template>
  </TimelineItem>
  <TimelineItem>
    <template #label>04</template>
    <template #title>
      Stay connected
    </template>
    <template #description>
      Partners can share implementation feedback, discuss technical developments, and stay connected to the evolution of Wren Security.
    </template>
  </TimelineItem>
</Timeline>

<ActionBanner variant="soft" class="wren-partner-form-banner">
  <template #title>
    Apply for partnership
  </template>
  <template #description>
    Partnership starts with a conversation about Wren Security, relevant IAM experience, and the types of projects where the platform could be used.
  </template>
